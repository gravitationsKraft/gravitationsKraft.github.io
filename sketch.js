...
var duoMassInput, duoMassInput2, duospaceInput;
...
function setup() {
    ...
    duoMassInput2 = createInput();
    duoMassInput2.position(bx + 40, by + 70 + 20);
    duoMassInput2.size(40, 15);
    duoMassInput2.value(31);

    duospaceInput = createInput();
    duospaceInput.position(bx, by + 70 + 20);
    duospaceInput.size(33.5, 15);
...
function duo_Button() {
    ...
    var mass2 = duoMassInput2.value();
    ps.push(new Particle(width / 2 - space / 2, height / 2 - height / 4, mass, true));
    ps.push(new Particle(width / 2 + space / 2, height / 2 - height / 4, mass2, false));
};
